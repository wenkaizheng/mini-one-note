...
/**
 * This class stores all necessary information related NoteSearch.
 * @author Wenkai Zheng
 */
public class NoteLink extends NoteShape {
    private double x, y, w, h, XChanged, YChanged;
	private double originalX, originalY;
	private double finalX = 0, finalY = 0;
    private final NoteModel.Functionality sign = NoteModel.Functionality.SEARCH;
    private String url;
    /**
     * 
     * @param x  position x
     ...
     */
    public NoteLink(double x, double y, double w, double h, String url) {
    	this.x = x;
		this.y = y;
		this.finalX = x;
		this.finalY = y;
